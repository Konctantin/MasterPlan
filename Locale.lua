...
L == "zhCN" and {
	...
	["Can be countered by:"] = "应对者：", -- Needs review
	...
	["Followers with this trait:"] = "有此特长的追随者：", -- Needs review
	["Follower XP"] = "追随者经验",
	["Garrison resources"] = "要塞资源",
	["Group %d"] = "组合 %d",
	Ignore = "忽略", -- Needs review
	Ignored = "已忽略", -- Needs review
	["In Tentative Party"] = "在预设队伍中",
	["Mission duration"] = "任务时间",
	["Mission level"] = "任务等级",
	["Mission order:"] = "任务排序：",
	["Pending: %s |4hour:hours;"] = "等待：%s |4hour:小时;", -- Needs review
	Ready = "就绪",
	["Reward: %s XP"] = "奖励：%s 经验",
	["+%s experience expected"] = "预计 +%s 经验",
	Success = "成功",
	["Success chance"] = "成功几率",
	["Suggested groups"] = "推荐组合", -- Needs review
	["%s XP"] = "%s 经验", -- Needs review
	["%s XP gained"] = "获得 %s 经验",
	Unignore = "取消忽略", -- Needs review
	["View Rewards"] = "查看奖励",
