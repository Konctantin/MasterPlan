...
L == "deDE" and {
	...
	["Can be countered by:"] = "Gekontert von:", -- Needs review
	...
	Done = "Fertig",
	["%d%% success chance"] = "%d%% Erfolgschance", -- Needs review
	...
	["Pending: %s |4hour:hours;"] = "Ausstehend: %s |4Stunde:Stunden;", -- Needs review
	Ready = "Bereit",
	["Reward: %s XP"] = "Belohnung: %s EP", -- Needs review
	["+%s experience expected"] = "+%s Erfahrung erwartet",
	Success = "Erfolgreich",
	["Success chance"] = "Erfolgschance",
	["%s XP"] = "%s EP",
	["%s XP gained"] = "%s EP erhalten", -- Needs review
...
L == "esMX" and {
	...
	["Can be countered by:"] = "Contrarrestado por:", -- Needs review
	...
	["Pending: %s |4hour:hours;"] = "Pendiente: %s |4hour:hours;", -- Needs review
	Ready = "Listo",
...
L == "esES" and {
	...
	["Additional mission loot may be delivered via mail."] = "Botín adicional de misiones podría ser enviado vía correo.",
	["Available Missions (%d)"] = "Misiones disponibles (%d)",
	["Can be countered by:"] = "Contrarrestada por:", -- Needs review
	["Chance of success"] = "Probabilidad de éxito",
	["Click to view upgrade options"] = "Click para ver opciones de actualizado",
	["Complete All"] = "Completar todos.",
	["Complete Missions"] = "Completar Misiones",
...
L == "itIT" and {
	...
	["Can be countered by:"] = "Contrastato da:", -- Needs review
...
L == "ruRU" and {
	...
	["Pending: %s |4hour:hours;"] = "Ожидание: %s |4час:часа:часов;", -- Needs review
	Ready = "Готово",
...
L == "zhTW" and {
	...
	["Can be countered by:"] = "反制於：", -- Needs review
	["Chance of success"] = "成功機率",
	["Click to view upgrade options"] = "點擊檢視升級選項", -- Needs review
	["Complete All"] = "全部完成",
	["Complete Missions"] = "完成任務",
	["Complete party"] = "完成隊伍", -- Needs review
	Done = "完成",
	["Expedited mission completion"] = "加速完成任務",
	Failed = "失敗",
	["Follower experience"] = "追隨者經驗",
	["Followers with this trait:"] = "有此特長的追隨者:",
	["Follower XP"] = "追隨者經驗", -- Needs review
	...
	["Mission level"] = "任務等級",
	["Mission order:"] = "任務排序:",
	["Pending: %s |4hour:hours;"] = "擱置：%s|4hour:小時;", -- Needs review
	Ready = "完成",
	["+%s experience expected"] = "經驗期望值: %s ", -- Needs review
	Success = "成功",
	["Success chance"] = "成功機率",
	["%s XP"] = "%s 經驗",
	["View Rewards"] = "檢視獎勵",
...
L == "frFR" and {
	...
	["Can be countered by:"] = "Contrecarré par :", -- Needs review
	...
	Done = "Terminé",
	["%d%% success chance"] = "%d%% chance de succès",
	...
	["Pending: %s |4hour:hours;"] = "Délai : %s |4hour:h restantes;", -- Needs review
	Ready = "Prêt",
	["+%s experience expected"] = "Expérience attendue : +%s",
	Success = "Réussite",
	["Success chance"] = "Chances de réussite",
	["%s XP"] = "%s EXP",
	["%s XP gained"] = "%s EXP gagnée",
