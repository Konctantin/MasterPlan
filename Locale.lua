...
L == "koKR" and {
	...
	["Group %d"] = "%d그룹 ",
	["Group suggestions will be updated to include the selected follower."] = "선택한 추종자를 포함해야 하므로 추천 그룹 명단을 업데이트 합니다.",
	Idle = "대기중",
	...
	["Select a follower to focus on"] = "주시해서 키울 추종자를 선택하세요",
