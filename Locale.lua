...
L == "esES" and {
	...
	["Using this item replaces a random trait."] = "Usando este objeto reemplazarás un rasgo aleatorio.",
...
L == "esMX" and {
	...
	Unignore = "Quitar Ignorar",
	["Using this item replaces a random trait."] = "Al usar este objeto se reemplazará una característica al azar.",
	["View Rewards"] = "Mostrar Recompensas",
	["You have no followers to counter this mechanic."] = "No tienes ningún seguidor que contrarreste esta mecánica.",
...
L == "frFR" and {
	...
	["Available; expires in %s"] = "Disponible; expire en %s",
...
L == "itIT" and {
	...
	["Available; expires in %s"] = "Disponibile; scade nel %s",
...
L == "koKR" and {
	...
	["Available; expires in %s"] = "수행 가능; %s 후 만료",
...
L == "zhCN" and {
	...
	["You have no followers with duplicate counter combinations."] = "追随者没有重复的反制组合。",
