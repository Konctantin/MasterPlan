...
L == "deDE" and {
	...
	["Improves %s |4Mission of Interest:Missions of Interest;."] = "Verbessert %s |4Mission von Interessse:Missionen von Interesse;.",
	...
	["Re-training at Epic:"] = "Umschulung an Episch:",
...
Diese Einstellung kann die vorgeschlagen Gruppen und Mission-Sortierreihenfolge beeinflussen.]=],
	...
	["Usable in %s groups for %s Missions of Interest."] = "Einsetzbar in %s Gruppen für %s Missionen von Interesse.",
	["View Rewards"] = "Belohnungen ansehen",
	["Weapon levels:"] = "Waffenstufen:",
	["When a mission's reward can be increased by follower traits, groups can prioritize either the expected reward or mission success chance."] = "Wenn die Belohnung einer Mission von den Anhängereigenschaften gesteigert werden kann, können Gruppen Prioritäten bei entweder der erwarteten Belohnung oder der Missionserfolgschance gesetzt werden. ",
...
L == "koKR" and {
	...
	["Could improve groups for:"] = "파티 향상 가능:",
	...
	["Improves %s |4Mission of Interest:Missions of Interest;."] = "%s개의 주요 고소득 임무 향상",
	...
	["Re-training at Epic:"] = "영웅 등급에서 재훈련:",
...
이 기능은 추천 파티와 임무 정렬 순서에 적용됩니다.]=],
	...
	["Usable in %s groups for %s Missions of Interest."] = "%s개의 파티를 주요 고소득 임무 %s에서 사용할 수 있습니다.",
	["View Rewards"] = "보상 보기",
	["Weapon levels:"] = "무기 레벨:",
...
L == "ruRU" and {
	...
	["Re-training at Epic:"] = "Изменение особенностей  на эпическом:",
