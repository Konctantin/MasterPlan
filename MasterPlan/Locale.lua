...
Это может повлиять на предлагаемые группы и порядок сортировки миссий.]=],
	...
	["Upgrades are available for |cffffffff%d |4active follower:active followers;|r."] = "Возможно улучшить |cffffffff%d активных соратников. ",
...
这可能会影响建议的队伍和任务排序顺序。]=],
	...
	["Upgrades are available for |cffffffff%d |4active follower:active followers;|r."] = "可用于|cffffffff%d 激活追随者|r升级。",
	["View Rewards"] = "查看奖励",
	["Weapon levels:"] = "武器等级：",
...
這可能會改變建議的隊伍和任務排序。]=],
	...
	["Upgrades are available for |cffffffff%d |4active follower:active followers;|r."] = "|cffffffff%d 任用追隨者|r有可用的升級。",
	["View Rewards"] = "檢視獎勵",
	["Weapon levels:"] = "武器等級：",
