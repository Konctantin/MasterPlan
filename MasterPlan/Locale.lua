...
L == "koKR" and {
	...
	["Could be countered by re-rolling:"] = "능력을 재배정해서 제거 가능:",
...
L == "ruRU" and {
	...
	["Clear all tentative parties."] = "Очистить все предварительные группы.",
	["Clear Tentative Parties"] = "Очистить предварительную группу",
