...
L == "esES" and {
	...
	Done = "Listo",
	["%d parties remaining..."] = "Quedan %d grupos...",
...
L == "esMX" and {
	...
	Done = "Listo",
	["%d parties remaining..."] = "%d grupos restantes...",
	["%d%% success chance"] = "%d%% probabilidad de éxito",
...
L == "frFR" and {
	...
	Done = "Terminé",
	["%d parties remaining..."] = "%d groupes restants...",
...
L == "zhCN" and {
	...
	["Complete party"] = "完成队伍",
	["Considering inactive followers"] = "考虑中未激活追随者",
	["%dh %dm"] = "%d时 %d分",
	...
	["Inactive followers are only included in suggested groups when they are beneficial."] = "未激活追随者当有利时将只包含在建议队伍中。",
	Instant = "立即",
