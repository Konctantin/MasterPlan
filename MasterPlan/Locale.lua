...
L == "deDE" and {
	...
	["Desirable rewards"] = "Wünschenstwerte Belohnungen",
	["%dh %dm"] = "%dstd %dmin",
...
L == "esES" and {
	...
	["Clear all tentative parties."] = "Click derecho para borrar todos los grupos tentativos.",
...
L == "koKR" and {
	...
	["%d |4party:parties; remaining..."] = "남은 |4파티:파티; %d개...",
...
L == "ruRU" and {
	...
	["Clear all tentative parties."] = "Очистить все предварительно собранные команды.",
	["Clear Tentative Parties"] = "Очистить предварительно собранную группу",
	...
	["Select a follower to focus on"] = "Выбрать соратника под указателем мыши",
	["Send Tentative Parties"] = "Отправить предварительно собранные команды.",
	["Set tentative party"] = "Собрать предварительно собранную группу",
