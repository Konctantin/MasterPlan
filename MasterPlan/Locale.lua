...
L == "deDE" and {
	...
	["Considering inactive followers"] = "In Anbetracht inaktive Anhänger",
	["%d |4party:parties; remaining..."] = "%d |4Gruppe:Gruppen; Rest...",
	["%dh %dm"] = "%dstd %dmin",
	...
	Ignore = "Ignorieren",
	Ignored = "Ignoriert",
	["Ignoring inactive followers"] = "Das Ignorieren inaktive Anhänger",
	...
	Ready = "Bereit",
	["Redundant followers:"] = [=[Überflüssige Anhänger:
= Können ohne Beeinträchtigung der Missionen von Interessengruppen deaktiviert werden]=],
...
L == "frFR" and {
	...
	["Set tentative party"] = "Ensemble de groupe provisoire",
