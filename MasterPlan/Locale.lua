...
L == "deDE" and {
	...
	["Characters are added to this list when they interact with the Command Table or Garrison Cache."] = "Das Personal wird in diese Liste aufgenommen, wenn sie mit dem Kommando-Tisch in der Garnison interagieren.",
...
L == "zhTW" and {
	...
	["Characters are added to this list when they interact with the Command Table or Garrison Cache."] = "角色已被加入列表當指揮桌與要塞快取交互作用時。",
