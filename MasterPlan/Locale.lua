...
L == "deDE" and {
	...
	["Click to view upgrade options"] = "Klicken, um Upgradeoptionen anzuzeigen",
...
L == "ruRU" and {
	...
	["No ships are equipped to handle this mechanic."] = "Нет оснащенных кораблей, чтобы справиться с этой механикой.",
