...
L == "deDE" and {
	...
	["All current traits are required."] = "Alle momentanen Eigenschaften werden benötigt.",
	...
	[ [=[Redundant followers not known.
Open the %s tab.]=] ] = [=[Überflüssige Anhänger sind nicht bekannt.
Öffne den Tab %s.]=],
	...
	["Select equipment to install"] = "Wähle die Ausrüstung, die installiert werden soll",
	["Select equipment to replace"] = "Wähle die Ausrüstung, die ersetzt werden soll",
...
Diese Einstellung kann die vorgeschlagen Gruppen und Mission-Sortierreihenfolge beeinflussen.]=],
	...
	["Upgradable gear"] = "Aufwertungsfähige Ausrüstung",
	["Upgrades are available for |cffffffff%d active followers|r."] = "Aufwertungen sind für |cffffffff%d aktive Anhänger|r verfügbar.",
	...
	["You may replace these traits:"] = "Wahrscheinlich möchtest du diese Eigenschaften ersetzen:",
...
L == "esES" and {
	...
	[ [=[Redundant followers not known.
Open the %s tab.]=] ] = [=[No hay seguidores redundantes.
Abrir la pestaña %s.]=],
...
L == "koKR" and {
	["*"] = "*",
	["Abilities may be retrained."] = "능력 재훈련을 받아야 할 수도 있습니다.",
	...
	["Better than %s of players (based on %s uncertain missions)."] = "추종자의 %s 보다 낫습니다 (%s개의 불특정 임무 기반)",
	...
	[ [=[Redundant followers not known.
Open the %s tab.]=] ] = [=[잉여 추종자가 인식되지 않았습니다.
%s 탭을 열어주세요.]=],
...
이 기능은 추천 파티와 임무 정렬 순서에 적용됩니다.]=],
	...
	["Upgrades are available for |cffffffff%d active followers|r."] = "|cffffffff활성 추종자 %d명|r의 레벨 업그레이드가 가능합니다.",
	["View Rewards"] = "보상 보기",
	["Weapon levels:"] = "무기 레벨:",
	...
	["You may replace these traits:"] = "다음 속성을 교체할 수 있습니다:",
...
L == "ruRU" and {
	...
	["Additional mission loot may be delivered via mail."] = "Дополнительная добыча полученная с задания может быть доставлена по почте.",
	...
	Done = "Завершено",
	["%d%% success chance"] = "вероятность успеха %d%%",
	["%d total"] = "%d всего",
	...
	[ [=[Redundant followers not known.
Open the %s tab.]=] ] = [=[Лишние соратники не известны.
Откройте вкладку %s.]=],
	...
	["%s XP/h"] = "%s опыта/ч",
	["This follower could counter the following threats:"] = "Этот соратник может нейтрализовать угрозы:",
...
Это может повлиять на предлагаемые группы и порядок сортировки миссий.]=],
	...
	["Upgrades are available for |cffffffff%d active followers|r."] = "Возможно улучшить |cffffffff%d активных соратников. ",
...
L == "zhCN" and {
	...
	["Better than %s of players (based on %s uncertain missions)."] = "比 %s 玩家更好（给予 %s 不确定的任务）。",
...
这可能会影响建议的队伍和任务排序顺序。]=],
	...
	["Upgrades are available for |cffffffff%d active followers|r."] = "可用于|cffffffff%d 激活追随者|r升级。",
	["View Rewards"] = "查看奖励",
	["Weapon levels:"] = "武器等级：",
...
這可能會改變建議的隊伍和任務排序。]=],
	...
	["Upgrades are available for |cffffffff%d active followers|r."] = "|cffffffff%d 任用追隨者|r有可用的升級。",
	["View Rewards"] = "檢視獎勵",
	["Weapon levels:"] = "武器等級：",
