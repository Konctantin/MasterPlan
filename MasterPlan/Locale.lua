...
L == "frFR" and {
	...
	[ [=[Redundant followers not known.
Open the %s tab.]=] ] = [=[Sujets en surnombre pas connus.
Ouvrir l'onglet %s.]=],
...
Peut affecter la suggestion de groupes et l'ordre de tri des missions.]=],
	...
	["Upgrades are available for |cffffffff%d active followers|r."] = "Mises à niveau possible pour |cffffffff%d sujets actifs|r.",
